...
import { mode, transparentize } from "@chakra-ui/theme-tools";
const variantAccountMenu = (props: ChakraStyledOptions) => {
...
const variantLink = (props: ChakraStyledOptions) => {
    const { colorScheme: c } = props;
    return {
...
const variantMenuButton = (props: ChakraStyledOptions) => {
    const { colorScheme: c } = props;
...
const variantOutline = (props: ChakraStyledOptions) => {
    const { colorScheme: c } = props;
    return {
...
const variantSolid = (props: ChakraStyledOptions) => {
    const { colorScheme: c } = props;
    return {
        bg: mode(`${c}.400`, `${c}.600`)(props),
        textColor: mode(`${c}.0`, `${c}.900`)(props),
        _focus: {
            textDecoration: "underline",
        },
        _disabled: {
...
const variantGhost = (props: ChakraStyledOptions) => {
    const { colorScheme: c } = props;
