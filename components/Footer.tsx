            ...
            <Container as={Stack} maxW={"8xl"} py={10}>
                ...
                >
                    <Stack spacing={6}>
                        ...
                        {ui.webSiteConfig.COPYRIGHT_NAME && (
                            <Text fontSize={"sm"}>
                                © {moment().year()}{" "}
                                {ui.webSiteConfig.COPYRIGHT_NAME} All rights
                                reserved
                            </Text>
                        )}
